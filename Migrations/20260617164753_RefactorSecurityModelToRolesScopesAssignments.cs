...
{
    /// <inheritdoc />
    public partial class RefactorSecurityModelToRolesScopesAssignments : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KpiId = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserScopes_Departments_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "Departments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserScopes_Units_UnitId",
                        column: x => x.UnitId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserScopes_DepartmentId",
                table: "UserScopes",
                column: "DepartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_UserScopes_UnitId",
                table: "UserScopes",
                column: "UnitId");
