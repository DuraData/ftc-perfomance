...
public record UserProfileResponse(string Id, string FirstName, string LastName, string FullName, string Email, string? PhoneNumber, bool IsActive, bool MustChangePassword);
...
public record UserResponse(string Id, string FirstName, string LastName, string FullName, string Email, string? PhoneNumber, bool IsActive, bool MustChangePassword, DateTime? LastLoginAt);
